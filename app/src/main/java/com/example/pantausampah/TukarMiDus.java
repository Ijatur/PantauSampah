...
public class TukarMiDus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tukar_mi_dus);

        btnBack = findViewById(R.id.btnBack);
        btnTukar = findViewById(R.id.btnTukarMiDus);
        tvSisaPoin = findViewById(R.id.sisaPoinMiDus);
