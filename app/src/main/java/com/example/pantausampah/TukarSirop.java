...
public class TukarSirop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tukar_sirop);

        btnBack = findViewById(R.id.btnBack);
        btnTukar = findViewById(R.id.btnTukarSirop);
        tvSisaPoin = findViewById(R.id.sisaPoinSirop);
